...
const INFO_SPORT = L("Спорттук объекттер", "Спортивные объекты", "Sports facilities");
const INFO_HEALTHCARE = L("Саламаттык сактоо", "Здравоохранение", "Healthcare");
const INFO_RELIGION = L("Диний объекттер", "Религиозные объекты", "Religious facilities");
const INFO_LOCAL_SERVICES = L("Жергиликтүү кызматтар", "Местные службы", "Local services");
const INFO_COMMERCE_PRODUCTION = L("Соода жана өндүрүш", "Торговля и производство", "Commerce and production");
...
const DETAILED_VILLAGES: Village[] = [
  ...
  },
  {
    ...
    nameEn: "Jany-Talaa",
    showInfo: true,
    ...createLegacyVillageSections("zhany-talaa", "Жаңы-Талаа", "Жаңы-Талаа", "Jany-Talaa"),
    tagline: L(
      "Айыл чарбага таянган айыл",
      "Село, опирающееся на сельское хозяйство",
      "A village sustained by agriculture",
    ),
    intro: L(
      "Жаңы-Талаа айылында 2026-жылга карата 1 192 адам жана 224 кожолук жашайт. Айылдын негизги чарба багыттары - мал чарбачылыгы жана дыйканчылык; арпа, буудай, ал эми Көк-Ирим аймагында күрүч өстүрүлөт.",
      "В селе Жаңы-Талаа по состоянию на 2026 год проживают 1 192 человека в 224 хозяйствах. Основные направления хозяйства - животноводство и земледелие; выращиваются ячмень, пшеница, а в местности Көк-Ирим также рис.",
      "As of 2026, Jany-Talaa has 1,192 residents and 224 households. Livestock and crop farming are the main livelihoods, with barley and wheat grown locally and rice cultivated in the Kok-Irim area.",
    ),
    info: [
      { label: INFO_POP, value: L("1 192", "1 192", "1,192") },
      { label: INFO_HOUSEHOLDS, value: L("224", "224", "224") },
      { label: INFO_ABOVE_SEA, value: L("1 500-1 900 м", "1 500-1 900 м", "1,500-1,900 m") },
      { label: INFO_FROM_KARA_KULJA, value: L("20 км", "20 км", "20 km") },
      { label: INFO_TRAVEL_TIME, value: L("25-30 мүнөт", "25-30 минут", "25-30 minutes") },
      { label: INFO_VILLAGE_COORDINATES, value: L("40.6276601, 73.4638596", "40.6276601, 73.4638596", "40.6276601, 73.4638596") },
    ],
    history: L(
      "Жергиликтүү маалыматта бул жерде туруктуу конуштун калыптанышы 1958-жылдан башталганы жана мурда ачык талаа болгон аймактын Жаңы-Талаа деп аталып калганы айтылат. Ошол мезгилде Ленин атындагы колхоз, 1977-жылы Ульянов атындагы совхоз түзүмү эскерилет. Айылга электр энергиясы 1971-жылы, ичүүчү суу 1975-жылы жеткирилип, 1976-жылы ҮДТ имараты, 1979-жылы асфальт жол, 1980-жылы мектеп курулган. Азыр айылда А. Мырзайбраимов атындагы мектеп, спорт зал, компьютердик класс, мектепке чейинки топ, №6 ҮДТ, жергиликтүү администрация, маалыматтык-коммуникациялык борбор, китепкана, У. Жумагулов атындагы кичи футбол аянтчасы, Түркбай Ата аллеясы, мечит жана намазкана бар. Сугат каналдары жана жол боюндагы аялдамалар да көрсөтүлгөн.",
      "По местным сведениям, формирование постоянного поселения началось в 1958 году, когда ранее открытая местность получила название Жаңы-Талаа. В материалах того времени упоминается колхоз имени Ленина, а с 1977 года - совхоз имени Ульянова. Электричество появилось в 1971 году, питьевая вода - в 1975 году, здание ГСВ построили в 1976 году, асфальтовую дорогу - в 1979 году, школу - в 1980 году. Сегодня в селе имеются школа имени А. Мырзаибраимова, спортивный зал, компьютерный класс, дошкольная группа, ГСВ №6, местная администрация, информационно-коммуникационный центр, библиотека, мини-футбольное поле имени У. Жумагулова, аллея Түркбай Ата, мечеть и молитвенная комната. Также указаны оросительные каналы и придорожные остановки.",
      "Local material describes permanent settlement beginning in 1958, when previously open land came to be called Jany-Talaa. It mentions the Lenin collective farm at that time and the Ulyanov state farm structure from 1977. Electricity arrived in 1971, drinking water in 1975, a family doctor facility in 1976, an asphalt road in 1979, and a school in 1980. The village now has the A. Myrzaibraimov School, a sports hall, computer classroom, preschool group, Family Doctor Group No. 6, local administration, an information and communication centre, library, the U. Jumagulov mini-football field, Turkbay Ata alley, a mosque, and a prayer room. Irrigation canals and roadside bus stops are also documented.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: {
      lead: L(
        "Айыл чарба продукциясы үчүн муздаткыч кампа жана логистикалык борбор түзүү, ошондой эле дыйканчылыкты өнүктүрүү айылдын инвестициялык мүмкүнчүлүгү катары каралат. Бул багыттар азырынча сунушталган мүмкүнчүлүк болуп саналат.",
        "Создание холодильного склада и логистического центра для сельскохозяйственной продукции, а также развитие земледелия рассматриваются как инвестиционный потенциал села. Пока это только предлагаемые направления.",
        "Agricultural cold storage, a logistics centre, and further crop production are considered potential investment directions for the village. They remain proposed opportunities rather than operating projects.",
      ),
      items: [],
    },
    people: [],
    gallery: [],
    mapNote: L("Жаңы-Талаа айылы, Кара-Гуз аймагы", "Село Жаңы-Талаа, аймак Кара-Гуз", "Jany-Talaa village, Kara-Guz Aiyl Aimak"),
    related: [],
  },
  {
    slug: "zhetim-dobo",
    ...
    nameEn: "Jetim-Dobo",
    showInfo: true,
    ...createLegacyVillageSections("zhetim-dobo", "Жетим-Дөбө", "Жетим-Дөбө", "Jetim-Dobo"),
    tagline: L(
      "Кургак дыйканчылык жана мал чарба айылы",
      "Село богарного земледелия и животноводства",
      "A village of dryland farming and livestock",
    ),
    intro: L(
      "Жетим-Дөбө айылында 2026-жылга карата 1 270 адам жана 244 кожолук жашайт. Мал чарбачылыгы, арпа жана буудай өстүрүү, негизинен кайрак дыйканчылык жергиликтүү турмуштун өзөгүн түзөт.",
      "В селе Жетим-Дөбө по состоянию на 2026 год проживают 1 270 человек в 244 хозяйствах. Основу местной жизни составляют животноводство, выращивание ячменя и пшеницы и преимущественно богарное земледелие.",
      "As of 2026, Jetim-Dobo has 1,270 residents and 244 households. Livestock farming, barley and wheat cultivation, and predominantly dryland agriculture form the basis of local life.",
    ),
    info: [
      { label: INFO_POP, value: L("1 270", "1 270", "1,270") },
      { label: INFO_HOUSEHOLDS, value: L("244", "244", "244") },
      { label: INFO_ABOVE_SEA, value: L("1 800-1 900 м", "1 800-1 900 м", "1,800-1,900 m") },
      { label: INFO_FROM_KARA_KULJA, value: L("25 км", "25 км", "25 km") },
      { label: INFO_TRAVEL_TIME, value: L("30-40 мүнөт", "30-40 минут", "30-40 minutes") },
      { label: INFO_VILLAGE_COORDINATES, value: L("40.578047, 73.494322", "40.578047, 73.494322", "40.578047, 73.494322") },
    ],
    history: L(
      "Жергиликтүү тарыхый маалыматта алгачкы Кызыл Октябрь колхозу 1929-1932-жылдар ченинде уюшулганы айтылат. Жетим-Дөбө аталышы аймактагы жалгыз турган дөбө менен байланыштырылып, бул аталыш болжол менен 1939-1945-жылдары калыптанганы баяндалат. Айылда Т. Суранбаев атындагы Кара-Гуз мектеби, ашар жолу менен курулган спорт зал, компьютердик класс, мектепке чейинки мекеме, ФАП, Көлдөш Ата мечити, 2022-жылы курулган кичи футбол аянтчасы, тигүү цехи, эки чакан дүкөн жана аялдама бар. Болжол менен 2 км Жаңырык каналы калктын бир бөлүгүнө кызмат кылары көрсөтүлгөн.",
      "В местных исторических сведениях говорится, что первый колхоз Кызыл Октябрь был организован примерно в 1929-1932 годах. Название Жетим-Дөбө связывают с одиноко стоящим холмом, а его закрепление относят приблизительно к 1939-1945 годам. В селе есть школа Кара-Гуз имени Т. Суранбаева, построенный методом ашара спортивный зал, компьютерный класс, дошкольное учреждение, ФАП, мечеть Көлдөш Ата, мини-футбольное поле 2022 года, швейный цех, два небольших магазина и остановка. Указано, что канал Жаңырык длиной около 2 км обслуживает часть населения.",
      "Local history describes the first Kyzyl Oktyabr collective farm as being organized around 1929-1932. The name Jetim-Dobo is linked to a solitary hill in the area and is said to have taken hold around 1939-1945. The village has the T. Suranbaev Kara-Guz School, a community-built sports hall, computer classroom, preschool institution, FAP clinic, Koldosh Ata Mosque, a mini-football field built in 2022, a sewing workshop, two small shops, and a bus stop. The approximately 2 km Janyryk canal is described as serving part of the population.",
    ),
    tourism: {
      lead: L(
        "Жергиликтүү материалда Курбанали Сулейкеев 30 жылдан ашык убакыттан бери ээр, жүгөн жана башка ат жабдыктарын жасап келери айтылат. Бул маалымат айылдагы салттуу кол өнөрчүлүк тажрыйбасын көрсөтөт, бирок анын үйү туристтик объект катары сунушталбайт.",
        "В местном материале говорится, что Курбанали Сулейкеев более 30 лет изготавливает седла, уздечки и другую конскую упряжь. Это свидетельство живой традиции местного ремесла, однако его дом не представляется как туристический объект.",
        "Local material reports that Kurbanali Suleikeev has made saddles, bridles, and other horse tack for more than 30 years. This reflects a living local craft tradition, but his home is not presented as a tourism site.",
      ),
      items: [],
    },
    ...
    people: [],
    gallery: [],
    mapNote: L("Жетим-Дөбө айылы, Кара-Гуз аймагы", "Село Жетим-Дөбө, аймак Кара-Гуз", "Jetim-Dobo village, Kara-Guz Aiyl Aimak"),
    related: [],
  },
  {
    slug: "nasirdin",
    ...
    nameEn: "Nasirdin",
    showInfo: true,
    ...createLegacyVillageSections("nasirdin", "Насирдин", "Насирдин", "Nasirdin"),
    tagline: L(
      "Тоолуу дыйканчылык жана мал чарба айылы",
      "Горное село земледелия и животноводства",
      "A mountain village of farming and livestock",
    ),
    intro: L(
      "Насирдин айылында 2026-жылга карата 417 адам жана 115 кожолук жашайт. Мал чарбачылыгы, арпа жана буудай өстүрүү негизги чарба багыттарын түзөт. Айылда Кеңеш атындагы мектеп, ФАП, көпүрөлөр, шагыл жолдор, көчө жарыгы, электр энергиясы, мобилдик байланыш жана интернет бар.",
      "В селе Насирдин по состоянию на 2026 год проживают 417 человек в 115 хозяйствах. Основные направления хозяйства - животноводство, выращивание ячменя и пшеницы. В селе есть школа имени Кеңеш, ФАП, мосты, гравийные дороги, уличное освещение, электричество, мобильная связь и интернет.",
      "As of 2026, Nasirdin has 417 residents and 115 households. Livestock farming and the cultivation of barley and wheat are the main livelihoods. The village has the Kenesh School, a FAP clinic, bridges, gravel roads, street lighting, electricity, mobile service, and internet.",
    ),
    info: [
      { label: INFO_POP, value: L("417", "417", "417") },
      { label: INFO_HOUSEHOLDS, value: L("115", "115", "115") },
      { label: INFO_ABOVE_SEA, value: L("1 800-2 000 м", "1 800-2 000 м", "1,800-2,000 m") },
      { label: INFO_FROM_KARA_KULJA, value: L("34-35 км", "34-35 км", "34-35 km") },
      { label: INFO_TRAVEL_TIME, value: L("55-60 мүнөт", "55-60 минут", "55-60 minutes") },
      { label: INFO_VILLAGE_COORDINATES, value: L("40.5409816, 73.523528", "40.5409816, 73.523528", "40.5409816, 73.523528") },
    ],
    history: L(
      "Жергиликтүү маалыматта элдин бул жерге топтолуп отурукташуусу 1956-жыл ченинде жүрүп, конуш Насирдин деп аталып калганы айтылат. Документте айыл мурда Кеңеш деп аталганы жөнүндө карама-каршы маалымат да кездешет, ошондуктан бул аталыш расмий мурдагы ат катары берилбейт. Чырдай тарапка кеткен көпүрө 2023-жылы, дагы бир көпүрө 2005-жылы курулганы, 2025-жылы жашыл зона тигилгени көрсөтүлгөн. Ветеринардык адис бар, бирок өзүнчө ветеринардык пункт жок.",
      "По местным сведениям, заселение и объединение жителей происходило примерно в 1956 году, после чего поселение стало называться Насирдин. Документ также содержит противоречивое утверждение о прежнем названии Кеңеш, поэтому оно не приводится как подтверждённое официальное название. Указано, что мост в сторону Чырдая построили в 2023 году, ещё один мост - в 2005 году, а зелёную зону заложили в 2025 году. В селе работает ветеринарный специалист, но отдельного ветеринарного пункта нет.",
      "Local material describes settlement and consolidation taking place around 1956, after which the village came to be called Nasirdin. The document also contains a conflicting statement about Kenesh as an earlier name, so it is not presented as a confirmed former official name. A bridge toward Chyrdai is reported as built in 2023, another bridge in 2005, and a green zone planted in 2025. A veterinary specialist serves the village, but there is no separate veterinary point.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: {
      lead: L(
        "Мөмө-жемиш үчүн муздаткыч кампа түзүү, айыл чарбасын жана мал чарбачылыгын өнүктүрүү мүмкүнчүлүгү бар. Бул багыттар так долбоор эмес, келечектеги инвестициялык мүмкүнчүлүк катары гана каралат.",
        "Создание холодильного склада для фруктов, развитие сельского хозяйства и животноводства рассматриваются как возможные направления. Это не конкретные проекты, а лишь будущий инвестиционный потенциал.",
        "Fruit cold storage and further agricultural and livestock development are possible directions. These are not defined projects and are presented only as future investment potential.",
      ),
      items: [],
    },
    people: [],
    gallery: [],
    mapNote: L("Насирдин айылы, Кара-Гуз аймагы", "Село Насирдин, аймак Кара-Гуз", "Nasirdin village, Kara-Guz Aiyl Aimak"),
    related: [],
  },
  {
    slug: "kenesh",
    ...
    nameEn: "Kenesh",
    showInfo: true,
    ...createLegacyVillageSections("kenesh", "Кеңеш", "Кеңеш", "Kenesh"),
    tagline: L(
      "Дыйканчылык жана коомдук инфраструктура айылы",
      "Село земледелия и общественной инфраструктуры",
      "A village of farming and community infrastructure",
    ),
    intro: L(
      "Кеңеш айылында 2026-жылга карата 2 930 адам жана 552 кожолук жашайт. Мал чарбачылыгы, арпа жана буудай өстүрүү негизги чарба багыттарын түзөт, сугатта Кеңеш каналы пайдаланылат.",
      "В селе Кеңеш по состоянию на 2026 год проживают 2 930 человек в 552 хозяйствах. Основные направления хозяйства - животноводство, выращивание ячменя и пшеницы; для орошения используется канал Кеңеш.",
      "As of 2026, Kenesh has 2,930 residents and 552 households. Livestock farming and barley and wheat cultivation are the main livelihoods, with the Kenesh canal used for irrigation.",
    ),
    info: [
      { label: INFO_POP, value: L("2 930", "2 930", "2,930") },
      { label: INFO_HOUSEHOLDS, value: L("552", "552", "552") },
      { label: INFO_ABOVE_SEA, value: L("1 500-1 900 м", "1 500-1 900 м", "1,500-1,900 m") },
      { label: INFO_FROM_KARA_KULJA, value: L("20 км", "20 км", "20 km") },
      { label: INFO_TRAVEL_TIME, value: L("25-30 мүнөт", "25-30 минут", "25-30 minutes") },
      { label: INFO_VILLAGE_COORDINATES, value: L("40.6349881, 73.4264642", "40.6349881, 73.4264642", "40.6349881, 73.4264642") },
    ],
    history: L(
      "Жергиликтүү маалыматта аймак 1970-жылы Өзгөн районунан бөлүнүп, Кара-Кулжа административдик түзүмүнө өткөнү айтылат. Кийинки мезгилдерде Живпром жана Госспецхоз түзүмдөрү эскерилет. 1992-жылдан кийин Кара-Гуз айыл өкмөтү менен байланышта болуп, 2005-жылы Кеңеш айыл өкмөтү бөлүнгөн, 2024-жылы кайра Кара-Гуз айыл өкмөтүнө кошулган. Айылда Ж. Акматалиев атындагы мектеп, маалыматтык-коммуникациялык борбор, китепкана, мурдагы администрация имараты, согуш ардагерлерине арналган эстелик, үй-бүлөлүк дарыгерлер тобу, мектепке чейинки топ, кичи футбол аянтчасы, спорт зал, маданият үйү, мечит, аялдама, дүкөндөр, төлөм терминалы жана муниципалдык тазалык ишканасы бар. Жаңы бала бакча курулуп жатканы көрсөтүлгөн.",
      "По местным сведениям, в 1970 году территория была отделена от Узгенского района и вошла в административную структуру Кара-Кульджи. В последующие периоды упоминаются структуры Живпром и Госспецхоз. После 1992 года село было связано с Кара-Гузским айыл окмоту, в 2005 году Кеңешский айыл окмоту был выделен, а в 2024 году вновь объединён с Кара-Гузским айыл окмоту. В селе имеются школа имени Ж. Акматалиева, информационно-коммуникационный центр, библиотека, бывшее административное здание, мемориал ветеранам войны, группа семейных врачей, дошкольная группа, мини-футбольное поле, спортивный зал, дом культуры, мечеть, остановка, магазины, платёжный терминал и муниципальное санитарное предприятие. Указано, что строится новый детский сад.",
      "Local material states that the area was separated from Uzgen District in 1970 and entered the Kara-Kulja administrative structure. Later references include the Zhivprom and Gosspecchoz structures. After 1992 it was associated with the Kara-Guz village administration; a separate Kenesh village administration was formed in 2005 and merged back into Kara-Guz in 2024. The village has the J. Akmataliev School, an information and communication centre, library, former administrative building, war veterans memorial, family doctor group, preschool group, mini-football field, sports hall, culture house, mosque, bus stop, shops, a payment terminal, and municipal sanitation enterprise. A new kindergarten is reported as under construction.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Кеңеш айылы, Кара-Гуз аймагы", "Село Кеңеш, аймак Кара-Гуз", "Kenesh village, Kara-Guz Aiyl Aimak"),
    related: [],
  },
  {
    slug: "kalmatay",
    ...
    nameEn: "Kalmatay",
    showInfo: true,
    ...createLegacyVillageSections("kalmatay", "Калматай", "Калматай", "Kalmatay"),
    tagline: L(
      "Мал чарбачылыгы жана дыйканчылык өнүккөн айыл",
      "Село животноводства и земледелия",
      "A village of livestock and crop farming",
    ),
    intro: L(
      "Калматай айылында 2026-жылга карата 1 063 адам жана 214 кожолук жашайт. Айыл деңиз деңгээлинен 1 800-2 100 метр бийиктикте, район борборунан 35 км алыстыкта жайгашкан. Негизги чарба багыттары - мал чарбачылыгы жана дыйканчылык. Айылга шагыл жол жетет, электр энергиясы толук берилет, мобилдик байланыш жана интернет бар.",
      "В селе Калматай по состоянию на 2026 год проживают 1 063 человека в 214 хозяйствах. Оно расположено на высоте 1 800-2 100 метров над уровнем моря, в 35 км от районного центра. Основные направления хозяйства - животноводство и земледелие. К селу ведёт гравийная дорога, оно полностью обеспечено электроэнергией, доступны мобильная связь и интернет.",
      "As of 2026, Kalmatay has 1,063 residents and 214 households. It lies at an elevation of 1,800-2,100 metres, 35 km from the district centre. Livestock and crop farming are the main livelihoods. The village is reached by a gravel road, has full electricity supply, and has mobile and internet service.",
    ),
    info: [
      { label: INFO_AIMAK, value: L("Кара-Гуз", "Кара-Гуз", "Kara-Guz") },
      { label: INFO_POP, value: L("1 063", "1 063", "1,063") },
      { label: INFO_HOUSEHOLDS, value: L("214", "214", "214") },
      { label: INFO_ABOVE_SEA, value: L("1 800-2 100 м", "1 800-2 100 м", "1,800-2,100 m") },
      { label: INFO_FROM_KARA_KULJA, value: L("35 км", "35 км", "35 km") },
      { label: INFO_TRAVEL_TIME, value: L("40 мүнөттөй", "около 40 минут", "about 40 minutes") },
      { label: INFO_ECONOMY, value: L("Мал чарбачылыгы жана дыйканчылык", "Животноводство и земледелие", "Livestock and crop farming") },
      { label: INFO_ROAD, value: L("Шагыл жол", "Гравийная дорога", "Gravel road") },
      { label: INFO_UTILITIES, value: L("Электр энергиясы толук берилет, мобилдик байланыш жана интернет бар", "Полное электроснабжение, доступны мобильная связь и интернет", "Full electricity supply, mobile service, and internet are available") },
      { label: INFO_SCHOOL, value: L("А. Калматов атындагы мектеп", "Школа имени А. Калматова", "A. Kalmatov School") },
      { label: INFO_SPORT, value: L("Маматали Матиев атындагы спорт комплекси; Нурбек Токтомаматович Зикиров атындагы спорт клубу", "Спортивный комплекс имени Маматали Матиева; спортивный клуб имени Нурбека Токтомаматовича Зикирова", "Mamatali Matiev Sports Complex; Nurbek Toktomamatovich Zikirov Sports Club") },
      { label: INFO_HEALTHCARE, value: L("№6 ҮДТ, стоматологиялык жана тез жардам кызматтары", "ГСВ №6, стоматологическая помощь и служба скорой помощи", "Family Doctor Group No. 6, dental care, and ambulance service") },
      { label: INFO_RELIGION, value: L("Эки мечит жана бир намазкана", "Две мечети и одна молитвенная комната", "Two mosques and one prayer room") },
      { label: INFO_LOCAL_SERVICES, value: L("Милиция пункту жана жергиликтүү бийликтин өкүлчүлүгү", "Пункт милиции и представительство местной власти", "Police point and local government representation") },
      { label: INFO_COMMERCE_PRODUCTION, value: L("«Даниел» дүкөнү; Зикиров Токтомаматтын кум блок жана кыш чыгарган жеке ишканасы", "Магазин «Даниел»; частное предприятие Зикирова Токтомамата по производству пескоблоков и кирпича", "Daniel shop; Zikirov Toktomamat's private enterprise producing sand blocks and bricks") },
    ],
    history: L(
      "Жергиликтүү оозеки-тарыхый маалыматта айылдын аталышы Калматай аттуу адамдын урпактары менен байланыштырылат. Айыл Ворошилов атындагы колхоз менен байланышта болгон, Апыз Калматов колхоз башкармасынын төрагасы болуп иштеген. А. Калматов атындагы мектеп 1994-жылы элдик ашар жолу менен курулган.",
      "В местных устных исторических сведениях название села связывают с потомками человека по имени Калматай. Село было связано с колхозом имени Ворошилова, председателем правления колхоза работал Апыз Калматов. Школа имени А. Калматова была построена в 1994 году методом народного ашара.",
      "Local oral history links the village name with descendants of a person named Kalmatay. The village was associated with the Voroshilov collective farm, where Apyz Kalmatov served as chairman. A. Kalmatov School was built through community ashar work in 1994.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: {
      lead: L(
        "Аймакта айыл чарба продукциясы үчүн муздаткыч кампа жана логистикалык борбор түзүү, өсүмдүк жана мал чарбачылыгын өнүктүрүү мүмкүнчүлүгү бар. Бул мүмкүнчүлүк жердин айыл чарбасына ылайыктуулугу, сугат суусунун болушу жана бир нече айылдын тургундары өтүүчү жерде жайгашканы менен байланыштуу.",
        "На территории есть потенциал для создания холодильного склада и логистического центра для сельскохозяйственной продукции, а также для развития растениеводства и животноводства. Он связан с пригодностью земель для сельского хозяйства, наличием оросительной воды и расположением на пути жителей нескольких сёл.",
        "The area has potential for agricultural cold storage and a logistics centre, as well as further crop and livestock production. This potential is linked to suitable farmland, irrigation water, and its location on a route used by residents of several villages.",
      ),
      items: [],
    },
    people: [],
    gallery: [],
    mapNote: L("Калматай айылы, Кара-Кулжа району", "Село Калматай, Кара-Кульджинский район", "Kalmatay village, Kara-Kulja District"),
    related: [],
  },
  {
    slug: "kara-zhygach",
    ...
    nameEn: "Kara-Jygach",
    showInfo: true,
    ...createLegacyVillageSections("kara-zhygach", "Кара-Жыгач", "Кара-Жыгач", "Kara-Jygach"),
    tagline: L(
      "Мал чарбачылыгы жана дыйканчылык өнүккөн айыл",
      "Село животноводства и земледелия",
      "A village of livestock and crop farming",
    ...
    intro: L(
      "Кара-Жыгач айылында 2026-жылга карата 1 199 адам жана 264 кожолук жашайт. Айыл деңиз деңгээлинен 1 800-2 100 метр бийиктикте, район борборунан 37 км алыстыкта жайгашкан. Негизги чарба багыттары - мал чарбачылыгы жана дыйканчылык. Транспорттук байланыш орточо, электр энергиясы, мобилдик байланыш жана интернет бар.",
      "В селе Кара-Жыгач по состоянию на 2026 год проживают 1 199 человек в 264 хозяйствах. Оно расположено на высоте 1 800-2 100 метров над уровнем моря, в 37 км от районного центра. Основные направления хозяйства - животноводство и земледелие. Транспортное сообщение умеренное, доступны электричество, мобильная связь и интернет.",
      "As of 2026, Kara-Jygach has 1,199 residents and 264 households. It lies at an elevation of 1,800-2,100 metres, 37 km from the district centre. Livestock and crop farming are the main livelihoods. Transport access is moderate, and electricity, mobile service, and internet are available.",
    ),
    info: [
      { label: INFO_AIMAK, value: L("Кара-Гуз", "Кара-Гуз", "Kara-Guz") },
      { label: INFO_POP, value: L("1 199", "1 199", "1,199") },
      { label: INFO_HOUSEHOLDS, value: L("264", "264", "264") },
      { label: INFO_ABOVE_SEA, value: L("1 800-2 100 м", "1 800-2 100 м", "1,800-2,100 m") },
      { label: INFO_FROM_KARA_KULJA, value: L("37 км", "37 км", "37 km") },
      { label: INFO_TRAVEL_TIME, value: L("1-1,5 сааттай", "примерно 1-1,5 часа", "approximately 1-1.5 hours") },
      { label: INFO_ECONOMY, value: L("Мал чарбачылыгы жана дыйканчылык", "Животноводство и земледелие", "Livestock and crop farming") },
      { label: INFO_ROAD, value: L("Транспорттук байланыш орточо", "Умеренное транспортное сообщение", "Moderate transport access") },
      { label: INFO_UTILITIES, value: L("Электр энергиясы, мобилдик байланыш жана интернет бар", "Доступны электричество, мобильная связь и интернет", "Electricity, mobile service, and internet are available") },
    ],
    history: L(
      "Жергиликтүү материалда азыркы Кара-Жыгач аталышы 1998-жылдан бери колдонулуп жана катталып келери көрсөтүлөт.",
      "В местном материале указано, что нынешнее название Кара-Жыгач используется и зарегистрировано с 1998 года.",
      "Local material states that the present name Kara-Jygach has been used and registered since 1998.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Кара-Жыгач айылы, Кара-Кулжа району", "Село Кара-Жыгач, Кара-Кульджинский район", "Kara-Jygach village, Kara-Kulja District"),
    related: [],
  },
  {
    slug: "por",
    ...
    nameEn: "Por",
    showInfo: true,
    ...createLegacyVillageSections("por", "Пор", "Пор", "Por"),
    tagline: L(
      "Дыйканчылык жана мал чарбачылык айылы",
      "Село земледелия и животноводства",
      "A village of crop and livestock farming",
    ),
    intro: L(
      "Пор айылында 2026-жылга карата 1 756 адам жана 171 кожолук жашайт. Айыл деңиз деңгээлинен 1 800-2 000 метр бийиктикте, район борборунан 25 км алыстыкта жайгашкан. Негизги чарба багыттары - мал чарбачылыгы жана дыйканчылык. Арпа, буудай, картошка жана малина өстүрүлөт.",
      "В селе Пор по состоянию на 2026 год проживают 1 756 человек в 171 хозяйстве. Оно расположено на высоте 1 800-2 000 метров над уровнем моря, в 25 км от районного центра. Основные направления хозяйства - животноводство и земледелие. Выращиваются ячмень, пшеница, картофель и малина.",
      "As of 2026, Por has 1,756 residents and 171 households. It lies at an elevation of 1,800-2,000 metres, 25 km from the district centre. Livestock and crop farming are the main livelihoods. Barley, wheat, potatoes, and raspberries are grown.",
    ),
    info: [
      { label: INFO_AIMAK, value: L("Кара-Гуз", "Кара-Гуз", "Kara-Guz") },
      { label: INFO_POP, value: L("1 756", "1 756", "1,756") },
      { label: INFO_HOUSEHOLDS, value: L("171", "171", "171") },
      { label: INFO_ABOVE_SEA, value: L("1 800-2 000 м", "1 800-2 000 м", "1,800-2,000 m") },
      { label: INFO_FROM_KARA_KULJA, value: L("25 км", "25 км", "25 km") },
      { label: INFO_TRAVEL_TIME, value: L("30-40 мүнөт", "30-40 минут", "30-40 minutes") },
      { label: INFO_ECONOMY, value: L("Мал чарбачылыгы; арпа, буудай, картошка жана малина өстүрүү", "Животноводство; выращивание ячменя, пшеницы, картофеля и малины", "Livestock farming; barley, wheat, potato, and raspberry production") },
      { label: INFO_SCHOOL, value: L("Токтор Сыдыков атындагы мектеп", "Школа имени Токтора Сыдыкова", "Toktor Sydykov School") },
      { label: INFO_MEDICAL, value: L("М. Мураталиев атындагы ФАП", "ФАП имени М. Мураталиева", "M. Murataliev Feldsher-Obstetric Point") },
    ],
    history: L(
      "Жергиликтүү административдик материалда Пор 2015-жылдын 3-февралындагы расмий документте өзүнчө айыл катары көрсөтүлгөн. Токтор Сыдыков атындагы мектеп 1985-жылы «Жаңылык» мектеби катары курулуп, 2011-жылы капиталдык оңдоодон өткөн жана 2023-жылы актовый зал менен толукталган. М. Мураталиев атындагы ФАП 2016-жылы курулган. Пор мечити 2025-жылы жеке ишкер тарабынан курулган.",
      "В местном административном материале Пор указан как отдельное село в официальном документе от 3 февраля 2015 года. Школа имени Токтора Сыдыкова была построена в 1985 году как школа «Жаңылык», капитально отремонтирована в 2011 году и дополнена актовым залом в 2023 году. ФАП имени М. Мураталиева построен в 2016 году. Мечеть Пор была построена частным предпринимателем в 2025 году.",
      "Local administrative material lists Por as a separate village in an official document dated 3 February 2015. Toktor Sydykov School was built in 1985 as the Zhanylyk school, underwent major renovation in 2011, and gained an assembly hall in 2023. The M. Murataliev Feldsher-Obstetric Point was built in 2016. Por Mosque was built by a private entrepreneur in 2025.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: {
      lead: L(
        "Арпа, буудай, картошка жана малина өстүрүү, ошондой эле мал чарбачылыгы айылдын экономикалык жана инвестициялык мүмкүнчүлүгүн түзөт.",
        "Выращивание ячменя, пшеницы, картофеля и малины, а также животноводство формируют экономический и инвестиционный потенциал села.",
        "Barley, wheat, potato, and raspberry production, together with livestock farming, form the village's economic and investment potential.",
      ),
      items: [],
    },
    people: [],
    gallery: [],
    mapNote: L("Пор айылы, Кара-Кулжа району", "Село Пор, Кара-Кульджинский район", "Por village, Kara-Kulja District"),
    related: [],
  },
  {
    slug: "altyn-kurok",
    ...
    nameEn: "Altyn-Kurok",
    showInfo: true,
    ...createLegacyVillageSections("altyn-kurok", "Алтын-Күрөк", "Алтын-Күрөк", "Altyn-Kurok"),
    tagline: L(
      "Мал чарбачылыгы жана дыйканчылык өнүккөн айыл",
      "Село животноводства и земледелия",
      "A village of livestock and crop farming",
    ...
    intro: L(
      "Алтын-Күрөк айылында 2026-жылга карата 440 адам жана 76 кожолук жашайт. Айыл деңиз деңгээлинен болжол менен 1 800 метр бийиктикте, район борборунан 37 км алыстыкта жайгашкан. Негизги чарба багыттары - мал чарбачылыгы жана дыйканчылык.",
      "В селе Алтын-Күрөк по состоянию на 2026 год проживают 440 человек в 76 хозяйствах. Оно расположено примерно на высоте 1 800 метров над уровнем моря, в 37 км от районного центра. Основные направления хозяйства - животноводство и земледелие.",
      "As of 2026, Altyn-Kurok has 440 residents and 76 households. It lies at an elevation of approximately 1,800 metres, 37 km from the district centre. Livestock and crop farming are the main livelihoods.",
    ),
    info: [
      { label: INFO_AIMAK, value: L("Кара-Гуз", "Кара-Гуз", "Kara-Guz") },
      { label: INFO_POP, value: L("440", "440", "440") },
      { label: INFO_HOUSEHOLDS, value: L("76", "76", "76") },
      { label: INFO_ABOVE_SEA, value: L("болжол менен 1 800 м", "примерно 1 800 м", "approximately 1,800 m") },
      { label: INFO_FROM_KARA_KULJA, value: L("37 км", "37 км", "37 km") },
      { label: INFO_TRAVEL_TIME, value: L("1-1,5 сааттай", "примерно 1-1,5 часа", "approximately 1-1.5 hours") },
      { label: INFO_ECONOMY, value: L("Мал чарбачылыгы жана дыйканчылык", "Животноводство и земледелие", "Livestock and crop farming") },
    ],
    ...
    people: [],
    gallery: [],
    mapNote: L("Алтын-Күрөк айылы, Кара-Кулжа району", "Село Алтын-Күрөк, Кара-Кульджинский район", "Altyn-Kurok village, Kara-Kulja District"),
    related: [],
  },
  {
    slug: "oy-tal",
...

  {
    ...
    nameEn: "Sary-Kungoy",
    showInfo: true,
    ...createLegacyVillageSections("sary-kungoy", "Сары-Күңгөй", "Сары-Күңгөй", "Sary-Kungoy"),
    tagline: L(
      "Аймактын түштүк-батышындагы күнөстүү айыл",
      "Солнечное село на юго-западе территории",
      "A sunny village in the southwest of the territory",
    ),
    intro: L(
      "Сары-Күңгөй Рыспай Абдыкадыров айыл аймагынын түштүк-батыш бөлүгүндө, деңиз деңгээлинен 1 800 метр бийиктикте жайгашкан.",
      "Сары-Күңгөй находится в юго-западной части айыл аймака Рыспай Абдыкадыров на высоте 1 800 метров над уровнем моря.",
      "Sary-Kungoy is located in the southwestern part of Ryspai Abdykadyrov Aiyl Aimak at an elevation of 1,800 metres.",
    ),
    info: [
      { label: INFO_ABOVE_SEA, value: L("1 800 м", "1 800 м", "1,800 m") },
      { label: INFO_VILLAGE_COORDINATES, value: L("40.5063436, 73.618387", "40.5063436, 73.618387", "40.5063436, 73.618387") },
    ],
    history: L(
      "Жергиликтүү маалыматта айылдын аталышы күн жакшы тийип, түшүм эрте бышкан шарт менен байланыштырылат. Айылда И. Орозалиев атындагы орто мектеп, Сары-Күңгөй бала бакчасы, ФАП жана кичи футбол аянтчасы бар. Көчөлөрү Калназаров А. жана Айникеев З. аттарын алып жүрөт.",
      "По местному преданию, название села связывают с солнечными условиями, благодаря которым урожай созревал рано. В селе работают средняя школа имени И. Орозалиева, детский сад Сары-Күңгөй и ФАП, имеется мини-футбольная площадка. Улицы носят имена Калназарова А. и Айникеева З.",
      "A local account connects the village name with sunny conditions that helped crops ripen early. The village has the I. Orozaliev Secondary School, Sary-Kungoy kindergarten, a FAP clinic, and a mini-football pitch. Its streets are named after Kalnazarov A. and Ainikeev Z.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Сары-Күңгөй, Рыспай Абдыкадыров аймагы", "Сары-Күңгөй, аймак Рыспая Абдыкадырова", "Sary-Kungoy, Ryspai Abdykadyrov Aiyl Aimak"),
    related: [],
  },
  {
    slug: "sary-bulak",
    ...
    nameEn: "Sary-Bulak",
    showInfo: true,
    ...createLegacyVillageSections("sary-bulak", "Сары-Булак", "Сары-Булак", "Sary-Bulak"),
    tagline: L(
      "Аймактын чыгышындагы булактуу айыл",
      "Село родников в восточной части территории",
      "A village of springs in the east of the territory",
    ),
    intro: L(
      "Сары-Булак Рыспай Абдыкадыров айыл аймагынын чыгыш бөлүгүндө жайгашкан.",
      "Сары-Булак находится в восточной части айыл аймака Рыспай Абдыкадыров.",
      "Sary-Bulak is located in the eastern part of Ryspai Abdykadyrov Aiyl Aimak.",
    ),
    info: [
      { label: INFO_VILLAGE_COORDINATES, value: L("40.4855551, 73.6295021", "40.4855551, 73.6295021", "40.4855551, 73.6295021") },
    ],
    history: L(
      "Жергиликтүү маалыматта айылдын аталышы бул жерде булактар жана жер алдынан чыккан агын суулар көп болгону менен түшүндүрүлөт. Айылдагы көчөлөр Ш. Жолдошов жана А. Карабаев аттарын алып жүрөт.",
      "По местному преданию, название села объясняется многочисленными родниками и выходами подземных вод. Улицы в селе носят имена Ш. Жолдошова и А. Карабаева.",
      "A local account explains the village name through the area's numerous springs and flowing groundwater. Village streets are named after Sh. Joldoshov and A. Karabaev.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Сары-Булак, Рыспай Абдыкадыров аймагы", "Сары-Булак, аймак Рыспая Абдыкадырова", "Sary-Bulak, Ryspai Abdykadyrov Aiyl Aimak"),
    related: [],
  },
  {
    slug: "toguz-bulak",
    ...
    nameEn: "Toguz-Bulak",
    showInfo: true,
    ...createLegacyVillageSections("toguz-bulak", "Тогуз-Булак", "Тогуз-Булак", "Toguz-Bulak"),
    tagline: L(
      "Айыл аймактын административдик борбору",
      "Административный центр айыл аймака",
      "The administrative centre of the aiyl aimak",
    ),
    intro: L(
      "Тогуз-Булак Рыспай Абдыкадыров айыл аймагынын административдик борбору.",
      "Тогуз-Булак является административным центром айыл аймака Рыспай Абдыкадыров.",
      "Toguz-Bulak is the administrative centre of Ryspai Abdykadyrov Aiyl Aimak.",
    ),
    info: [
      { label: INFO_VILLAGE_COORDINATES, value: L("40.4720734, 73.6265838", "40.4720734, 73.6265838", "40.4720734, 73.6265838") },
    ],
    history: L(
      "Жергиликтүү маалыматта айылдын аталышы бир булактан тогуз жерден суу чыкканы менен байланыштырылат. Айылда Тогуз-Булак орто мектеби, М. Калбаев балдар бакчасы, булакта №8 ГСП деп көрсөтүлгөн объект, кичи футбол аянтчасы жана айыл өкмөтүнүн имараты бар. Көчөлөрү Д. Кубатов, А. Закиров, Сагын-Уулу, Тогуз-Булак жана Доңузой деп аталат.",
      "По местному преданию, название села связано с тем, что вода одного родника выходила в девяти местах. В селе находятся средняя школа Тогуз-Булак, детский сад имени М. Калбаева, указанный в источнике объект №8 ГСП, мини-футбольная площадка и здание айыл окмоту. Улицы названы Д. Кубатова, А. Закирова, Сагын-Уулу, Тогуз-Булак и Доңузой.",
      "A local account connects the village name with water emerging at nine points from one spring. The village has Toguz-Bulak Secondary School, the M. Kalbaev kindergarten, a facility identified in the source as No. 8 GSP, a mini-football pitch, and the aiyl government building. Streets include D. Kubatov, A. Zakirov, Sagyn-Uulu, Toguz-Bulak, and Donguzoi.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Тогуз-Булак, Рыспай Абдыкадыров аймагы", "Тогуз-Булак, аймак Рыспая Абдыкадырова", "Toguz-Bulak, Ryspai Abdykadyrov Aiyl Aimak"),
    related: [],
  },
  {
    slug: "konokbay-talaa",
    name: "Конокбай-Талаа",
    nameRu: "Конокбай-Талаа",
    nameEn: "Konokbay-Talaa",
    showInfo: true,
    ...createLegacyVillageSections("konokbay-talaa", "Конокбай-Талаа", "Конокбай-Талаа", "Konokbay-Talaa"),
    tagline: L(
      "Аймактын чыгышындагы айыл",
      "Село в восточной части территории",
      "A village in the east of the territory",
    ),
    intro: L(
      "Конокбай-Талаа Рыспай Абдыкадыров айыл аймагынын чыгыш бөлүгүндө жайгашкан.",
      "Конокбай-Талаа находится в восточной части айыл аймака Рыспай Абдыкадыров.",
      "Konokbay-Talaa is located in the eastern part of Ryspai Abdykadyrov Aiyl Aimak.",
    ),
    info: [
      { label: INFO_VILLAGE_COORDINATES, value: L("40.4197776, 73.6685979", "40.4197776, 73.6685979", "40.4197776, 73.6685979") },
    ],
    history: L(
      "Жергиликтүү оозеки маалыматта XX кылымдын баш ченинде бул жерде жергиликтүү «конок» деп аталган таруу айдалып, мол түшүм алынганы айылдын аталышына негиз болгону айтылат. Ошол эле маалыматта Ителги-Уя, Ничке-Жылга жана Алма жерлеринде жашаган элдин болжол менен 1955-жылы бир конушка топтолгону баяндалат. Айылда Ж. Калматаев атындагы башталгыч мектеп бар, көчөлөрү А. Калыкбердиев, К. Мамашев жана Т. Ракыев аттарын алып жүрөт.",
      "Согласно местному устному преданию, в начале XX века здесь выращивали просо, которое местные жители называли «конок», а богатые урожаи стали основой названия села. В том же предании говорится, что примерно в 1955 году жители мест Ителги-Уя, Ничке-Жылга и Алма объединились в одном поселении. В селе работает начальная школа имени Ж. Калматаева, улицы носят имена А. Калыкбердиева, К. Мамашева и Т. Ракыева.",
      "According to a local oral account, millet known locally as konok was cultivated here in the early twentieth century, and strong harvests inspired the village name. The same account says that people living in Itelgi-Uya, Nichke-Jylga, and Alma consolidated into one settlement around 1955. The village has the J. Kalmataev Primary School, and streets named after A. Kalykberdiev, K. Mamashev, and T. Rakyev.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Конокбай-Талаа, Рыспай Абдыкадыров аймагы", "Конокбай-Талаа, аймак Рыспая Абдыкадырова", "Konokbay-Talaa, Ryspai Abdykadyrov Aiyl Aimak"),
    related: [],
  },
  {
    slug: "tegerek-saz",
    ...
    nameEn: "Tegerek-Saz",
    showInfo: true,
    ...createLegacyVillageSections("tegerek-saz", "Тегерек-Саз", "Тегерек-Саз", "Tegerek-Saz"),
    tagline: L(
      "Аймактын түндүгүндөгү айыл",
      "Село в северной части территории",
      "A village in the north of the territory",
    ),
    intro: L(
      "Тегерек-Саз Рыспай Абдыкадыров айыл аймагынын түндүк бөлүгүндө жайгашкан.",
      "Тегерек-Саз находится в северной части айыл аймака Рыспай Абдыкадыров.",
      "Tegerek-Saz is located in the northern part of Ryspai Abdykadyrov Aiyl Aimak.",
    ),
    info: [
      { label: INFO_VILLAGE_COORDINATES, value: L("40.4257583, 73.6175877", "40.4257583, 73.6175877", "40.4257583, 73.6175877") },
    ],
    history: L(
      "Жергиликтүү маалыматта айылдын Тегерек-Саз деп аталышы анын айланасында саздуу жерлер көп болгону менен түшүндүрүлөт. Айылда Б. Эркинбаев атындагы орто мектеп, Б. Матиев бала бакчасы, Г. Эркинбаева атындагы ФАП жана кичи футбол аянтчасы бар. Көчөлөрү М. Калыбеков, А. Жумаев жана Ничке-Жылга деп аталат.",
      "По местному преданию, название Тегерек-Саз связано с многочисленными заболоченными участками вокруг села. Здесь работают средняя школа имени Б. Эркинбаева, детский сад имени Б. Матиева и ФАП имени Г. Эркинбаевой, имеется мини-футбольная площадка. Улицы названы М. Калыбекова, А. Жумаева и Ничке-Жылга.",
      "A local account explains the name Tegerek-Saz through the many marshy areas around the village. The village has the B. Erkinbaev Secondary School, B. Matiev kindergarten, G. Erkinbaeva FAP clinic, and a mini-football pitch. Streets include M. Kalybekov, A. Jumaev, and Nichke-Jylga.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Тегерек-Саз, Рыспай Абдыкадыров аймагы", "Тегерек-Саз, аймак Рыспая Абдыкадырова", "Tegerek-Saz, Ryspai Abdykadyrov Aiyl Aimak"),
    related: [],
  },
  {
    slug: "kara-bulak",
    ...
    nameEn: "Kara-Bulak",
    showInfo: true,
    ...createLegacyVillageSections("kara-bulak", "Кара-Булак", "Кара-Булак", "Kara-Bulak"),
    tagline: L(
      "Алай району менен чектешкен түндүк айыл",
      "Северное село на границе с Алайским районом",
      "A northern village bordering Alay District",
    ),
    intro: L(
      "Кара-Булак Рыспай Абдыкадыров айыл аймагынын түндүк бөлүгүндө жайгашып, Алай району менен чектешет.",
      "Кара-Булак находится в северной части айыл аймака Рыспай Абдыкадыров и граничит с Алайским районом.",
      "Kara-Bulak is located in the northern part of Ryspai Abdykadyrov Aiyl Aimak and borders Alay District.",
    ),
    info: [
      { label: INFO_VILLAGE_COORDINATES, value: L("40.4240595, 73.5828263", "40.4240595, 73.5828263", "40.4240595, 73.5828263") },
    ],
    history: L(
      "Жергиликтүү маалыматта айылдын аталышы Кара-Булак деп аталган булак менен байланыштырылат. Айылда Э. Алязов атындагы негизги мектеп жана Кара-Булак бала бакчасы бар. Көчөлөрү О. Эркебаев жана Бообек уулу Шералы аттарын алып жүрөт.",
      "По местному преданию, название села связано с родником Кара-Булак. В селе работают основная школа имени Э. Алязова и детский сад Кара-Булак. Улицы носят имена О. Эркебаева и Бообек уулу Шералы.",
      "A local account connects the village name with a spring called Kara-Bulak. The village has the E. Alyazov Basic School and Kara-Bulak kindergarten. Its streets are named after O. Erkebaev and Boobek uulu Sheraly.",
    ),
    tourism: { lead: L("", "", ""), items: [] },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Кара-Булак, Рыспай Абдыкадыров аймагы", "Кара-Булак, аймак Рыспая Абдыкадырова", "Kara-Bulak, Ryspai Abdykadyrov Aiyl Aimak"),
    related: [],
  },
  {
    slug: "kyzyl-bulak",
    ...
    nameEn: "Kyzyl-Bulak",
    showInfo: true,
    ...createLegacyVillageSections("kyzyl-bulak", "Кызыл-Булак", "Кызыл-Булак", "Kyzyl-Bulak"),
    tagline: L(
      "Рыспай Абдыкадыровдун туулган айылы",
      "Родное село Рыспая Абдыкадырова",
      "The birthplace of Ryspai Abdykadyrov",
    ),
    intro: L(
      "Кызыл-Булак Рыспай Абдыкадыров айыл аймагынын түндүк бөлүгүндө жайгашкан. Бул айыл белгилүү обончу жана ырчы Рыспай Абдыкадыровдун туулган жери.",
      "Кызыл-Булак находится в северной части айыл аймака Рыспай Абдыкадыров. Это родина известного композитора и певца Рыспая Абдыкадырова.",
      "Kyzyl-Bulak is located in the northern part of Ryspai Abdykadyrov Aiyl Aimak. It is the birthplace of the noted composer and singer Ryspai Abdykadyrov.",
    ),
    info: [],
    history: L(
      "Жергиликтүү маалыматта айылдын аталышы жаандан кийин аккан суунун кызыл түсү жана жердин кызыл топурагы менен түшүндүрүлөт. Айылда К. Чаргынов атындагы орто мектеп, Кызыл-Булак балдар бакчасы, №29 ГСВ, К. Атабеков атындагы кичи футбол аянтчасы жана Р. Абдыкадыров атындагы үй музейи бар. Көчөсү А. Бостаевдин атын алып жүрөт.",
      "По местному преданию, название села объясняется красным цветом стоков после дождя и красной почвой. В селе находятся средняя школа имени К. Чаргынова, детский сад Кызыл-Булак, ГСВ №29, мини-футбольная площадка имени К. Атабекова и дом-музей Р. Абдыкадырова. Улица носит имя А. Бостаева.",
      "A local account explains the village name through red-coloured runoff after rain and the area's red soil. The village has the K. Chargynov Secondary School, Kyzyl-Bulak kindergarten, GSV No. 29, the K. Atabekov mini-football pitch, and the R. Abdykadyrov house museum. Its street is named after A. Bostaev.",
    ),
    tourism: {
      lead: L(
        "Рыспай Абдыкадыров атындагы үй музейи - айылдагы композитордун маданий мурасын тааныткан тарыхый-маданий жай.",
        "Дом-музей имени Рыспая Абдыкадырова - историко-культурное место, знакомящее с наследием композитора в его родном селе.",
        "The Ryspai Abdykadyrov house museum is a historical-cultural site presenting the composer's legacy in his home village.",
      ),
      items: [],
    },
    investment: { lead: L("", "", ""), items: [] },
    people: [],
    gallery: [],
    mapNote: L("Кызыл-Булак, Рыспай Абдыкадыров аймагы", "Кызыл-Булак, аймак Рыспая Абдыкадырова", "Kyzyl-Bulak, Ryspai Abdykadyrov Aiyl Aimak"),
    related: [],
  },
